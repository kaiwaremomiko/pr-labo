class ManufacturesController < ApplicationController
  ...
  private
    ...
    def manufacture_params
      params.require(:manufacture).permit(:corporate_name, :category, :industry, :address, :tel_number, :establishment, :capital, :employees, :postal_code, :official_site, :img, :pr)
    end
end
